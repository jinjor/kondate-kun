  ...
  render: function() {
    ...
    return (
      <div className="detail">
        <h2>{date}</h2>
        <form className="form">
          <div><label htmlFor="breakfast">朝</label><input id="breakfast" value={data.breakfast} onChange={this.saveBreakfast.bind(this, data)}></input></div>
          <div><label htmlFor="lunch">昼</label><input id="lunch" value={data.lunch} onChange={this.saveLunch.bind(this, data)}></input></div>
          <div><label htmlFor="dinner">夜</label><input id="dinner" value={data.dinner} onChange={this.saveDinner.bind(this, data)}></input></div>
        </form>
      </div>
    );
  }
